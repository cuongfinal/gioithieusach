      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="flex flex-col items-center gap-4 text-center">
          <div className="flex items-center gap-2 text-lg font-semibold" style={{ color: Colors.White }}>
            <span>📚</span>
            <span>Góc Sách Hay</span>
          </div>
          <p className="max-w-md text-sm" style={{ color: Colors.TextLight }}>
            Dự án giới thiệu sách của học sinh THCS — Lan tỏa tình yêu đọc sách
            đến mọi người.
          </p>
          <div
          ...
          <p className="text-xs" style={{ color: Colors.TextSecondary }}>
            © 2024 Góc Sách Hay. Được thực hiện bởi học sinh Trường THCS Nguyễn
            Du.
          </p>
        </div>
      </div>
